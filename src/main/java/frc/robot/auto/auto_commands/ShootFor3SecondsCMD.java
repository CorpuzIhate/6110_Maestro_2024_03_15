...
public class ShootFor3SecondsCMD extends Command  {
    ...
    public ShootFor3SecondsCMD(ShooterSub shooterSub, boolean shooterBool, double totalTime, IndexerSub indexerSub){
    ...
    public void execute() {
        shooterSub.setShooterSpeed(1);
         indexerSub.setIndexSpeed(-IndexerConstants.kIndexelowerMaxSpeed, -IndexerConstants.kIndexerUpperMaxSpeed);
    }
