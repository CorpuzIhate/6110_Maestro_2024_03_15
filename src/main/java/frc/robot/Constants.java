...
public final class Constants {
  ...
  public static final class ModuleConstants{
   ...
   public static final class DriveConstants {
    ...
    public static final class IntakeConstants {
      ...
      public static final double kIntakeArmDownPosSetpoint = 0.5; // 2024 / 03/ 13/ 1:05pm
      public static final double kIntakeArmMidPosSetpoint = 0.65;
      public static final double kIntakeArmUpPosSetpoint = 0.66;// 2024 / 03/ 13/ 1:05pm
    ...
    public static final class  shooterArmConstants {
        public static final int kShooterArmID = 14;
  ...
  public static class LimeLightConsants{
    ...
    public static final double kMinShoot = 26;
    public static final double kMaxShoot = 29;
  ...
  public static class IndexerConstants {
    ...
    public static final double kIndexerUpperMaxSpeed = 0.4;
