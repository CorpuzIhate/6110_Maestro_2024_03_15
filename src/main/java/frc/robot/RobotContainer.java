...
public class RobotContainer {
  ...
  //autos
  private final MoveForwardSwerveAuto moveForwardSwerveAuto = new MoveForwardSwerveAuto(this);
  ...
  //new JoystickTrigger(driverJoyStick, OIConstants.kIndexerButtonIdx).whileTrue(new IndexerCMD(indexerSub, 0));
   ...
   new JoystickButton(driverJoyStick, OIConstants.kDriveShooterOutButtonIdx).whileTrue(new ShooterCMD(shooterSub,  1));
   new JoystickButton(driverJoyStick, OIConstants.kDriveShooterInButtonIdx).whileTrue(new ShooterCMD(shooterSub,  -0.2));
  //new RunCommand(null, null)
   
  
 indexInTrigger.whileTrue(new IndexerCMD(indexerSub, 1, 0.5));
 new JoystickButton(driverJoyStick,OIConstants.kIntakeButtonIdx ).whileTrue(new IntakeCMD(intakeOutakeSub, true, false  ));
