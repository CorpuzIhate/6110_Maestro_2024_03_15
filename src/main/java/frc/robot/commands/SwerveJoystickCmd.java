  ...
  public void execute() {
    ...
    SmartDashboard.putBoolean("LL Orient Function", limeLightOrientFunction.get());
     ...
     if(fieldOrientedFunction.get() && !limeLightOrientFunction.get()){ // field orientations
        ...
        double limelightXSpeed = limeLightSub.getLimelightDistancePIDOutput(((LimeLightConsants.kMaxShoot+LimeLightConsants.kMinShoot)/2) - limeLightSub.calculateDistanceFromTarget());
